...
if (!window.config.unityWebglLoaderUrl) {
    ...
    switch (year) {
    case "2019":
        window.config.unityWebglLoaderUrl = 1 === minor ? "patch/poki/UnityLoader.2019.1.js" : "patch/poki/UnityLoader.2019.2.js";
        break;
    default:
        window.config.unityWebglLoaderUrl = "patch/poki/UnityLoader.js"
    }
}
var sdkScript = document.createElement("script");
sdkScript.src = "./patch/poki/sdk-v2.js",
